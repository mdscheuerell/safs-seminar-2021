...
.blue-text[
### 2. maintained at current classification
]

.green-text[
### 3. reclassified from endangered to threatened (downlist)
]

.green-text[
### 4. removed from the list (delist)
]
...
# Most of the data is gappy, noisy, and comes from disparate sources
...
# A: One option is a state-space model
