...
# Conterminous bull trout in the western US
...
$$N(t) = N_0 ~ \underbrace{\exp(u)}_{\substack{\text{growth} \\ \text{rate}}} \underbrace{\exp(w t)}_{\substack{\text{stochastic} \\ \text{environment}}}$$
...
# Example of 3 observations of a common state
